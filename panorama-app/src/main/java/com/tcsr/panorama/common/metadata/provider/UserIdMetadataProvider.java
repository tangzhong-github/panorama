 ...
 */
@Component
public class UserIdMetadataProvider extends AbstractMetadataProvider<Long> {

    public UserIdMetadataProvider(){
        super(MetadataTypeConstants.USER_ID, SecurityUtils::getUserId);
    }
